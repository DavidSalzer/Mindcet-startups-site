...
<script type="text/javascript" src="http://localhost/Mindcet-startups-site/wp-content/themes/mindcet-Theme/js/selection.js"></script>-->
	...
	<link rel="stylesheet" href="wp-content/themes/mindcet-Theme/wp-style.css" type="text/css" />
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div id="single-startup-zone"class="inventDescription">
        <div class="inventContener">
			...
			<div class="nextImage" id="nextImageL"></div><div class="nextImage" id="nextImageR"></div>
...
<script>
    ...
    <!--<div id="marker-popup" class="mapDescription" style="display: block;">-->
        ...
        <div id="newsletter-popup">
            ...
            <div id="newsletter-success">Thank you for subscribing to our newsletter.</div>
